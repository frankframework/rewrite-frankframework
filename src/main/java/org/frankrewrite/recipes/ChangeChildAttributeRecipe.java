...
import org.frankrewrite.recipes.visitors.ChangeChildAttributeVisitor;
import org.openrewrite.*;

public class ChangeChildAttributeRecipe extends Recipe {
    @Option(displayName = "Tag name",
            description = "The tag name to replace the child's attribute for.",
            required = false)
    String tagNameFilter;
    @Option(displayName = "Child tag name",
            description = "The child's tag name to replace the attribute for.",
            required = false)
    ...
    @JsonCreator
    public ChangeChildAttributeRecipe(@JsonProperty("tagNameFilter")String tagNameFilter,@JsonProperty("childTagNameFilter")String childTagNameFilter, @JsonProperty("attributeKeyFilter")String attributeKeyFilter, @JsonProperty("newKey")String newKey, @JsonProperty("attributeValueFilter")String attributeValueFilter, @JsonProperty("newValue")String newValue) {
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new ChangeChildAttributeVisitor(tagNameFilter, childTagNameFilter, attributeKeyFilter, newKey, attributeValueFilter, newValue);
    }
}
